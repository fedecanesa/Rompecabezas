...
var instrucciones = ["Utiliza las fechas mover las piezas y completar el rompecabezas","¡Let´s go!"];
...
function mostrarUltimaDireccion(direccion){
...
function chequearSiGano() {
  ...
  for(i = 0; i < grilla.length; i++){
      //Se recorre "grillaGanadora"    
      for(j = 0; j < grillaGanadora.length; j++){
...
function mostrarCartelGanador() {
  swal("Hecho", "¡Has completado el juego!","success");
  } 
